...
var reader = (function (){var or__3936__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__3936__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
return (128);
...
var G__28199 = cljs.core.PersistentArrayMap.EMPTY;
var G__28200 = native_stack_trace;
var G__28201 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__28202 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__28199,G__28200,G__28201,G__28202) : cljs.stacktrace.parse_stacktrace.call(null,G__28199,G__28200,G__28201,G__28202));
});
...
var map__28206 = top_item;
var map__28206__$1 = ((((!((map__28206 == null)))?(((((map__28206.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28206.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28206):map__28206);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28203){var _e = e28203;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___28209 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___28209)){
var seen_errors_28210 = temp__5455__auto___28209;
if(cljs.core.truth_(seen_errors_28210.has(self))){
} else {
seen_errors_28210.add(self);

var temp__5457__auto___28211 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___28211)){
var sense_28212 = temp__5457__auto___28211;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28212)].join('');
} else {
}
}
} else {
