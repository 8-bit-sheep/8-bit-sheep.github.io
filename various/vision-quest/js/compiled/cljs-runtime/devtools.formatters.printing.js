...
var len__4518__auto___28239 = arguments.length;
var i__4519__auto___28240 = (0);
while(true){
if((i__4519__auto___28240 < len__4518__auto___28239)){
args__4521__auto__.push((arguments[i__4519__auto___28240]));

var G__28241 = (i__4519__auto___28240 + (1));
i__4519__auto___28240 = G__28241;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4522__auto__);
});
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28236){
var G__28237 = cljs.core.first(seq28236);
var seq28236__$1 = cljs.core.next(seq28236);
var G__28238 = cljs.core.first(seq28236__$1);
var seq28236__$2 = cljs.core.next(seq28236__$1);
var self__4505__auto__ = this;
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28237,G__28238,seq28236__$2);
});
...
if(cljs.core.truth_((function (){var or__3936__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__4179__auto__,writer__4180__auto__,opt__4181__auto__){
return cljs.core._write(writer__4180__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__3925__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__3925__auto__){
var or__3936__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28260_SHARP_){
return !((cljs.core.meta(p1__28260_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28263__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__3936__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e28267){var _e__26925__auto__ = e28267;
return false;
}})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
}catch (e28269){var _e__26925__auto__ = e28269;
return false;
}}
})())){
...
var _STAR_current_state_STAR_28272 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__28273 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28273__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_28272;
}});
...
;
var temp__5455__auto___28289 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___28289)){
var managed_print_level_28290 = temp__5455__auto___28289;
var _STAR_print_level_STAR_28281_28291 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_28290;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_28281_28291,managed_print_level_28290,temp__5455__auto___28289,writer,opts,job_fn){
return (function (p1__28277_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28277_SHARP_,null);
});})(_STAR_print_level_STAR_28281_28291,managed_print_level_28290,temp__5455__auto___28289,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_28281_28291;
}} else {
job_fn();
}
