...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26137,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26137,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__26140){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26141__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26141__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26141__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26141__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26141__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__26143 = (new goog.Uri());
G__26143.setScheme(cljs.core.name((function (){var or__3936__auto__ = scheme;
...
G__26143.setDomain(server_name);

G__26143.setPort(server_port);

G__26143.setPath(uri);

G__26143.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26145_SHARP_,p2__26144_SHARP_){
var vec__26146 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__26144_SHARP_,/:\s+/);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__26145_SHARP_,clojure.string.lower_case(k),v);
}
