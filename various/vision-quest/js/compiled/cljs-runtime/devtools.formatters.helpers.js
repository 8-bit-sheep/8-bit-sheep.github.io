...
var G__28150 = devtools.prefs.pref(v);
v = G__28150;
continue;
} else {
return v;
...
var and__3925__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3925__auto__){
var and__3925__auto____$1 = !(cljs.core.var_QMARK_(value));
...
var or__3936__auto__ = (function (){try{if(!((value == null))){
...
}catch (e28178){var _e__26925__auto__ = e28178;
return false;
}})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e28184){var _e__26925__auto__ = e28184;
return false;
}})();
...
}catch (e28188){var _e__26925__auto__ = e28188;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__3925__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__3925__auto__)){
var and__3925__auto____$1 = cljs.core.not(devtools.formatters.helpers.is_prototype_QMARK_(f));
if(and__3925__auto____$1){
...
var and__3925__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__3925__auto__)){
...
var or__3936__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
var and__3925__auto__ = (function (){var or__3936__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
var vec__28195 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28195,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28195,(1),null);
...
var and__3925__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__3925__auto__)){
...
var or__3936__auto__ = typeof value === 'string';
if(or__3936__auto__){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = typeof value === 'number';
...
return cljs.core.some((function (p1__28198_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28198_SHARP_);
}),template);
});
