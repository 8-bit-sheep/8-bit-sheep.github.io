...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4179__auto__,writer__4180__auto__,opt__4181__auto__){
return cljs.core._write(writer__4180__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__35791 = o;
(G__35791[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35796){
...
var props = map__35797__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35797__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35800){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35801__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__35801,map__35801__$1,on_write){
return (function (){
...
});})(node_value,map__35801,map__35801__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__35818){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35819__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35819__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__3925__auto__ = !((jsprops == null));
if(and__3925__auto__){
var and__3925__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__35825 = jsprops;
(G__35825["defaultValue"] = value);

(G__35825["onChange"] = ((function (G__35825,v,value,on_change,on_change__$1,map__35819,map__35819__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__35815_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__35815_SHARP_);
});})(G__35825,v,value,on_change,on_change__$1,map__35819,map__35819__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__35866 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35866,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35866,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35866,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___35873 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___35873 == null)){
} else {
var key_35874 = temp__5461__auto___35873;
(jsprops["key"] = key_35874);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__35885){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35886__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__35891 = reagent.impl.template.__GT_NativeWrapper();
(G__35891["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__35893 = wrapped;
(G__35893["syntheticInput"] = true);

return G__35893;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__35895 = wrapped__$1;
(G__35895["syntheticOnChange"] = on_change);

return G__35895;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__35897 = wrapped__$2;
(G__35897["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__3936__auto__ = synthetic_input;
...
var len__4518__auto___35942 = arguments.length;
var i__4519__auto___35943 = (0);
while(true){
if((i__4519__auto___35943 < len__4518__auto___35942)){
args__4521__auto__.push((arguments[i__4519__auto___35943]));

var G__35944 = (i__4519__auto___35943 + (1));
i__4519__auto___35943 = G__35944;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4522__auto__);
});
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35939){
var G__35940 = cljs.core.first(seq35939);
var seq35939__$1 = cljs.core.next(seq35939);
var self__4505__auto__ = this;
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35940,seq35939__$1);
});
...
break;
default:
var G__35953 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__35953;
continue;
...
var n__4395__auto___35981 = a.length;
var i_35982 = (0);
while(true){
if((i_35982 < n__4395__auto___35981)){
(a[i_35982] = reagent.impl.template.as_element((a[i_35982])));

var G__35983 = (i_35982 + (1));
i_35982 = G__35983;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4395__auto___35993 = a.length;
var i_35994 = (0);
while(true){
if((i_35994 < n__4395__auto___35993)){
var val_35995 = (a[i_35994]);
if(((cljs.core.vector_QMARK_(val_35995)) && ((reagent.impl.template.key_from_vec(val_35995) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35994] = reagent.impl.template.as_element(val_35995));

var G__35996 = (i_35994 + (1));
i_35994 = G__35996;
continue;
} else {
}
...
var ctx = ({});
var vec__35997 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35997,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35997,(1),null);
...
case (1):
var G__36009 = comp;
var G__36010 = jsprops;
var G__36011 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36009,G__36010,G__36011);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__36008){
