...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__25793_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__25793_SHARP_),cljs.core.second(p1__25793_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__25798_SHARP_,p2__25799_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__25798_SHARP_,p2__25799_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__25823 = cljs.core.first(path_pieces);
switch (G__25823) {
case "":
...
var G__25832 = cljs.core.first(path_pieces);
var G__25832__$1 = (((G__25832 instanceof cljs.core.Keyword))?G__25832.fqn:null);
switch (G__25832__$1) {
case "root":
...
var G__25854 = cljs.core.last(path_pieces);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cwd","cwd",14056523),G__25854)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",G__25854)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"root","root",-448657453),G__25854)){
return path_pieces;
} else {
...
var pred__25894 = cljs.core._EQ_;
var expr__25895 = curr;
if(cljs.core.truth_((pred__25894.cljs$core$IFn$_invoke$arity$2 ? pred__25894.cljs$core$IFn$_invoke$arity$2(null,expr__25895) : pred__25894.call(null,null,expr__25895)))){
return suffix;
} else {
if(cljs.core.truth_((pred__25894.cljs$core$IFn$_invoke$arity$2 ? pred__25894.cljs$core$IFn$_invoke$arity$2("",expr__25895) : pred__25894.call(null,"",expr__25895)))){
var G__25903 = suffix;
var G__25905 = cljs.core.rest(remainder);
suffix = G__25903;
remainder = G__25905;
continue;
} else {
if(cljs.core.truth_((pred__25894.cljs$core$IFn$_invoke$arity$2 ? pred__25894.cljs$core$IFn$_invoke$arity$2(".",expr__25895) : pred__25894.call(null,".",expr__25895)))){
var G__25906 = suffix;
var G__25907 = cljs.core.rest(remainder);
suffix = G__25906;
remainder = G__25907;
continue;
} else {
if(cljs.core.truth_((pred__25894.cljs$core$IFn$_invoke$arity$2 ? pred__25894.cljs$core$IFn$_invoke$arity$2("..",expr__25895) : pred__25894.call(null,"..",expr__25895)))){
var G__25908 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,"..");
var G__25909 = cljs.core.rest(remainder);
suffix = G__25908;
remainder = G__25909;
continue;
} else {
var G__25910 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,curr);
var G__25911 = cljs.core.rest(remainder);
suffix = G__25910;
remainder = G__25911;
continue;
}
...
var vec__25933 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25933,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25933,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25933,(2),null);
...
var vec__25938 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25938,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25938,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25938,(2),null);
