...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_10194 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_10194(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_10195 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_10195(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10196 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10196(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10197 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10197(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10198 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10198(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10199 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10199(reader);
}
});
...
var G__10210 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__10211 = s.append(c);
c = G__10210;
s = G__10211;
continue;
}
