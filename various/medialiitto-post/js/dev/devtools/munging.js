...
var o45538 = temp__5733__auto__;
var temp__5733__auto____$1 = (o45538["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o45539 = temp__5733__auto____$1;
return (o45539["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29127__auto__ = f;
return (o__29127__auto__["toString"]).call(o__29127__auto__);
} else {
return "";
}
}catch (e45540){var _ = e45540;
return "";
}});
...
try{var o__29127__auto___45542 = t;
(o__29127__auto___45542["cljs$lang$ctorPrWriter"]).call(o__29127__auto___45542,t,writer);
}catch (e45541){var __45543 = e45541;
}
...
var char_code = (function (){var o__29127__auto__ = (new String(char$));
return (o__29127__auto__["charCodeAt"]).call(o__29127__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29127__auto__ = String;
return (o__29127__auto__["fromCharCode"]).call(o__29127__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45544 = num_code;
switch (G__45544) {
case (1):
return (185);
...
var o__29127__auto__ = String;
return (o__29127__auto__["fromCharCode"]).call(o__29127__auto__,superscript_code);
});
/**
...
}catch (e45546){var _e__29134__auto__ = e45546;
return false;
}})())){
...
var vec__45547 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__45547,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o45550 = temp__5733__auto__;
var temp__5733__auto____$1 = (o45550["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o45551 = temp__5733__auto____$1;
return (o45551["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45554){
var vec__45555 = p__45554;
var ns_detector = cljs.core.nth.call(null,vec__45555,(0),null);
...
var G__45561 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__45562 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__45561;
remaining_tokens = G__45562;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45552){
var G__45553 = cljs.core.first.call(null,seq45552);
var seq45552__$1 = cljs.core.next.call(null,seq45552);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45553,seq45552__$1);
}));
...
var vec__45566 = cljs.core.split_with.call(null,(function (p1__45565_SHARP_){
return cljs.core.not_EQ_.call(null,p1__45565_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__45566,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__45566,(1),null);
...
var vec__45572 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__45572,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__45572,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__45575 = cljs.core.rest.call(null,remaining_tokens);
var G__45576 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__45575;
name_tokens = G__45576;
continue;
} else {
...
var vec__45579 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__45579,(0),null);
var arity = cljs.core.nth.call(null,vec__45579,(1),null);
var vec__45582 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__45582,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__45582,(1),null);
var vec__45585 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__45585,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__45585,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__45585,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__45585,(3),null);
...
var vec__45591 = result;
var munged_ns = cljs.core.nth.call(null,vec__45591,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__45591,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__45591,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__45591,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__45591,(4),null);
var arity = cljs.core.nth.call(null,vec__45591,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__45595 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__45595,(0),null);
var args = cljs.core.nth.call(null,vec__45595,(1),null);
var vec__45598 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__45598,(0),null);
var name = cljs.core.nth.call(null,vec__45598,(1),null);
...
var G__45601 = (arity + (1));
var G__45602 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45603){
var vec__45604 = p__45603;
var arity = cljs.core.nth.call(null,vec__45604,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__45604,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__45607_SHARP_){
return cljs.core.get.call(null,arities,p1__45607_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__45608_SHARP_){
return cljs.core.drop.call(null,(2),p1__45608_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___45615 = arguments.length;
var i__4737__auto___45616 = (0);
while(true){
if((i__4737__auto___45616 < len__4736__auto___45615)){
args__4742__auto__.push((arguments[i__4737__auto___45616]));

var G__45617 = (i__4737__auto___45616 + (1));
i__4737__auto___45616 = G__45617;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45611){
var vec__45612 = p__45611;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__45612,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45609){
var G__45610 = cljs.core.first.call(null,seq45609);
var seq45609__$1 = cljs.core.next.call(null,seq45609);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45610,seq45609__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__45620__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__45620__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__45620__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__45620__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45621 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__45621,(0),null);
var fn_name = cljs.core.nth.call(null,vec__45621,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__45621,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__45621,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__45621,(4),null);
var arity = cljs.core.nth.call(null,vec__45621,(5),null);
...
var o__29127__auto__ = f;
return (o__29127__auto__["getBasis"]).call(o__29127__auto__);
});
/**
...
}catch (e45625){var _e__29134__auto__ = e45625;
...
var G__45626 = (obj[cljs.core.first.call(null,path)]);
var G__45627 = cljs.core.rest.call(null,path);
obj = G__45626;
path = G__45627;
continue;
} else {
...
var _STAR_ = (function (accum,p__45628){
var vec__45629 = p__45628;
var bit = cljs.core.nth.call(null,vec__45629,(0),null);
var protocol = cljs.core.nth.call(null,vec__45629,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45632){
var vec__45633 = p__45632;
var ns = cljs.core.nth.call(null,vec__45633,(0),null);
var name = cljs.core.nth.call(null,vec__45633,(1),null);
var selector = cljs.core.nth.call(null,vec__45633,(2),null);
...
var post_process = (function (p__45637){
var vec__45638 = p__45637;
var munged_name = cljs.core.nth.call(null,vec__45638,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__45638,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__45636_SHARP_){
return (obj[cljs.core.first.call(null,p1__45636_SHARP_)]);
}),sorted_matches);
