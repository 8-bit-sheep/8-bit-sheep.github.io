...
var G__45661 = devtools.prefs.pref.call(null,v);
v = G__45661;
continue;
} else {
return v;
...
}catch (e45664){var _e__29134__auto__ = e45664;
return false;
}})();
...
}catch (e45668){var _e__29134__auto__ = e45668;
return false;
}})();
...
}catch (e45670){var _e__29134__auto__ = e45670;
return false;
}}
}
});
...
var vec__45672 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__45672,(0),null);
var name = cljs.core.nth.call(null,vec__45672,(1),null);
...
return cljs.core.some.call(null,(function (p1__45675_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45675_SHARP_);
}),template);
});
