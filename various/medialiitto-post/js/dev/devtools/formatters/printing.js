...
var len__4736__auto___45710 = arguments.length;
var i__4737__auto___45711 = (0);
while(true){
if((i__4737__auto___45711 < len__4736__auto___45710)){
args__4742__auto__.push((arguments[i__4737__auto___45711]));

var G__45712 = (i__4737__auto___45711 + (1));
i__4737__auto___45711 = G__45712;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45707){
var G__45708 = cljs.core.first.call(null,seq45707);
var seq45707__$1 = cljs.core.next.call(null,seq45707);
var G__45709 = cljs.core.first.call(null,seq45707__$1);
var seq45707__$2 = cljs.core.next.call(null,seq45707__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45708,G__45709,seq45707__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45713_SHARP_){
return (!((cljs.core.meta.call(null,p1__45713_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__45714__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e45718){var _e__29134__auto__ = e45718;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e45720){var _e__29134__auto__ = e45720;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__45722 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__45723 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__45723);

try{var map__45724 = opts;
var map__45724__$1 = (((((!((map__45724 == null))))?(((((map__45724.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45724.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45724):map__45724);
var markup_db = cljs.core.get.call(null,map__45724__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__45722);
}});
...
var temp__5733__auto___45729 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___45729)){
var managed_print_level_45730 = temp__5733__auto___45729;
var _STAR_print_level_STAR__orig_val__45727_45731 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45728_45732 = managed_print_level_45730;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45728_45732);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__45726_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45726_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45727_45731);
}} else {
job_fn.call(null);
}
