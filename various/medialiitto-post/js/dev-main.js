window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=b9d752&fwbuild=dev"};
...
document.write('<script>goog.require("sakalli.triads_front");</script>');
